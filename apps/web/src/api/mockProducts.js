export const mockProducts = [
  {
    ...
    collections: [
      { collection_id: "col-ebooks", product_id: "mock-daily-planner", order: 1 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "How to Use", description: "<p>Simply import the PDF file directly into GoodNotes, Notability, or any PDF annotation app. Use your stylus to tap on interactive hyperlinked tabs to navigate instantly between sheets.</p>" }
    ],
    type: {
      value: "Ebooks"
    },
  ...
  {
    id: "mock-digital-stickers",
    title: "Whimsical Digital Stickers Bundle",
    ...
    collections: [
      { collection_id: "col-stickers", product_id: "mock-digital-stickers", order: 2 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Compatability", description: "<p>Works on any device running GoodNotes, Notability, Xodo, Flexcil, or any app that supports transparent PNG images.</p>" }
    ],
    type: {
  ...
  },
  {
    ...
    collections: [
      { collection_id: "col-templates", product_id: "mock-website-template", order: 3 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Licensing Rules", description: "<p>Includes a Developer License, which permits use on one personal website and up to three commercial client projects. No redistribution or reselling of the code is permitted.</p>" }
    ],
    type: {
  ...
  },
  {
    ...
    variants: [
      {
        id: "mock-childrens-book-v1",
        title: "Storybook + Coloring Pages Pack",
        price_in_cents: 699,
        sale_price_in_cents: null,
        currency: "USD",
    ...
    collections: [
      { collection_id: "col-kids", product_id: "mock-childrens-book", order: 4 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Age Suitability", description: "<p>Perfect for reading out loud to ages 3-6, or independent reading for ages 7-10.</p>" }
    ],
    type: {
  ...
  {
    id: "mock-tshirt-design",
    title: "Streetwear Typography T-Shirt Vector Pack",
    ...
    variants: [
      {
        id: "mock-tshirt-design-v1",
        title: "Commercial Vector License",
        price_in_cents: 1999,
        sale_price_in_cents: null,
        currency: "USD",
    ...
    collections: [
      { collection_id: "col-apparel", product_id: "mock-tshirt-design", order: 5 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Commercial Terms", description: "<p>Comes with an unlimited print-on-demand license. You can print and sell these graphics on physical merchandise without royalty constraints.</p>" }
    ],
    type: {
      value: "T-Shirt Designs"
    },
    custom_fields: [],
    related_products: [],
    updated_at: "2026-06-29T00:00:00.000Z"
  ...
  {
    id: "mock-figma-uikit",
    title: "AuraUI - Glassmorphic Design System & UI Kit",
    ...
    variants: [
      {
        id: "mock-figma-uikit-v1",
        title: "Standard Figma License",
        price_in_cents: 2499,
        sale_price_in_cents: null,
        currency: "USD",
    ...
    collections: [
      { collection_id: "col-uikit", product_id: "mock-figma-uikit", order: 6 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Figma File Version", description: "<p>Compatible with Figma variables and full-component styling. Constantly updated with free lifetime component patches.</p>" }
    ],
    type: {
      value: "UI Kits"
    },
  ...
  {
    id: "mock-gallery-app",
    title: "ArtDisplay - Minimalist Portfolio Gallery React App",
    ...
    collections: [
      { collection_id: "col-apps", product_id: "mock-gallery-app", order: 7 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Installation", description: "<p>Unzip the files and run <code>npm install</code> followed by <code>npm run dev</code>. Comprehensive documentation included.</p>" }
    ],
    type: {
      value: "Gallery Apps"
    },
  ...
  },
  {
    ...
    collections: [
      { collection_id: "col-tools", product_id: "mock-software-tool", order: 8 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Platform OS Support", description: "<p>Supports macOS 12+ (Apple Silicon & Intel) and Windows 10/11.</p>" }
    ],
    type: {
  ...
  {
    id: "mock-stock-photos",
    title: "Candid Warm Tone Creator Workspace Stock Photo Pack",
    ...
    variants: [
      {
        id: "mock-stock-photos-v1",
        title: "Full Studio stock pack",
        price_in_cents: 1200,
        sale_price_in_cents: null,
        currency: "USD",
    ...
    collections: [
      { collection_id: "col-photos", product_id: "mock-stock-photos", order: 9 }
    ],
    additional_info: [
      { id: "info1", order: 1, title: "Image License", description: "<p>Lifetime royalty-free commercial license. Use across websites, printable goods, ads, and templates.</p>" }
    ],
    type: {
      value: "Stock Photos"
    },
